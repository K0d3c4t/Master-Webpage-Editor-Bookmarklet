...
This script allows you to have a tool simular to inspect element that can be used to view the way a webpage works with more snippets or if inspect element is blocked/not working on your device.
...
### Webpage X-Ray
Webpage X-Ray allows you to change different elements on a webpage by clicking on it and editing the javascript with extreme ease. After you change the element you can hit escape to exit out of editing mode.

## Settings

## Credits
[Offbrand Inspect Element Script](https://github.com/liriliri/eruda)
[Webpage X-ray Script](https://x-ray-goggles.mouse.org/)
